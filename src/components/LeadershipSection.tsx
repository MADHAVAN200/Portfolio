    ...
    <section id="leadership" className="py-10 relative overflow-hidden bg-white dark:bg-[#050505] border-t border-gray-100 dark:border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          <span className="text-xs font-semibold font-sans tracking-wide text-indigo-600 dark:text-indigo-400 flex items-center justify-center gap-1.5 mb-2">
            <Users className="w-3.5 h-3.5" /> Leadership & Influence
          </span>
