    ...
    <div className="min-h-screen text-gray-800 dark:text-gray-200 dark:bg-[#050505] bg-[#fafafa] selection:bg-blue-500 selection:text-white transition-colors duration-300 font-sans text-xs">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-white/5 text-gray-600 dark:text-gray-300 transition-colors"
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="fixed inset-x-0 top-[49px] z-40 bg-white/97 dark:bg-[#07070a]/97 backdrop-blur-xl border-b border-gray-200/60 dark:border-zinc-800/70 shadow-xl"
          >
            {/* Nav links */}
            ...
            {/* Bottom CTA + socials */}
            <div className="px-4 pb-5 pt-2 border-t border-gray-100 dark:border-zinc-800/70 space-y-3">
              <button
        ...
        <div className="max-w-4xl mx-auto space-y-5">
          ...
          <SectionWrap>
            <div className="grid grid-cols-12 gap-5 items-start">
              {/* Left side tabs */}
              <div className="col-span-12 flex flex-row gap-1.5 overflow-x-auto pb-1.5 scrollbar-none">
      ...
      <section id="projects" className="py-6 px-4 bg-gray-50/20 dark:bg-zinc-950/40 border-t border-gray-200/50 dark:border-zinc-800/60">
        <div className="max-w-4xl mx-auto space-y-5">
          ...
          <SectionWrap>
            <div className="flex flex-row gap-1.5 pb-1 overflow-x-auto scrollbar-none whitespace-nowrap px-1 justify-start">
      ...
      <section id="leadership" className="py-6 px-4 border-t border-gray-200/50 dark:border-zinc-800/60 font-sans">
        <div className="max-w-4xl mx-auto space-y-5">
          ...
          <CardStagger className="grid grid-cols-1 gap-4">
