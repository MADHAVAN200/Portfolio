    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="text-xs font-semibold font-mono tracking-wider text-violet-600 dark:text-violet-400 flex items-center justify-center gap-1.5 mb-2.5 uppercase">
            <Terminal className="w-3.5 h-3.5" /> Technical Topology
          </span>
